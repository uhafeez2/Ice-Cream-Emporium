...
Emporium::Emporium(std::istream& ist) {
   ...
   else if (header2 == "Manager") _managers.push_back(Manager{ist}); //manager
...
int Emporium::num_managers() {return _managers.size();} //managers
...
Manager& Emporium::manager(int index) {return _managers[index];} //manager
...
void Emporium::add_manager(Manager manager) {_managers.push_back(manager);} //manager
