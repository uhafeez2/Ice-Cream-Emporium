...
void on_display_costs_click(int order); //display expenses
        void on_display_server_prep_click(int order);  // Display a specific order receipt
void on_display_inventory_click(int order);  // Display a specific order receipt
